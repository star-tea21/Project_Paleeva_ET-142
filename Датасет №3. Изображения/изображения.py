...
# =========================================================================================
# 1.3.2 Примеры типичных изображений (оригинальный размер)
# =========================================================================================
import random
...
# =========================================================================================
# 1.3.3 Примеры типичных изображений (после масштабирования до 512x512)
# =========================================================================================
import random
from PIL import Image
import io
...
# =========================================================================================
# 1.3.4 Оценка качества изображений (оригинальный размер)
# =========================================================================================
import numpy as np
...
# =========================================================================================
# 1.3.5 Масштабирование изображений до размера 512x512 с помощью фильтра Ланцоша
# =========================================================================================
# Параметры
...
with zipfile.ZipFile(src_zip, 'r') as zin, \
    ...
    for fname in tqdm(all_files, desc='Масштабирование'):
        try:
            # Читаем исходное изображение
            data = zin.read(fname)
            img = Image.open(io.BytesIO(data))

            # Масштабируем с использованием фильтра Ланцоша
...
# =========================================================================================
# 1.3.6 Оценка качества изображений (после масштабирования)
# =========================================================================================
# Параметры
zip_path = '/content/UTKFace_512x512.zip'
...
with zipfile.ZipFile(zip_path, 'r') as zf:
    ...
    for fname in tqdm(all_img, desc='Проверка качества после масштабирования'):
        info = zf.getinfo(fname)
        if info.file_size == 0:
            zero_size.append(fname)
            continue
...
# =========================================================================================
# 1.3.8 Оценка качества разметки (ручная верификация)
# =========================================================================================
# Интерактивный блок для Jupyter Notebook с кнопками управления
...
# =========================================================================================
# 1.3.9 Структура каталогов и аннотации. Создание CSV-файла с разбивкой на выборки
# =========================================================================================
import csv
